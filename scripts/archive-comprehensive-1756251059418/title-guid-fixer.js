...
/**
 * Title and GUID correction tool
 * 
 * Consolidated from: fix-track-titles.js, fix-titles-from-urls.js, quick-title-fix.js, final-fix-titles.js, fix-guid-mismatches.js, fix-mp3-guid-tracks.js, expanded-guid-fix.js
...
class UnifiedTool {
  ...
  showHelp() {
    console.log(`
🛠️  Title and GUID correction tool

Usage: node scripts/title-guid-fixer.js [command] [options]
...
Examples:
  node scripts/title-guid-fixer.js analyze --file=data/tracks.json
  node scripts/title-guid-fixer.js resolve --feed-guid=abc123 --item-guid=def456
  node scripts/title-guid-fixer.js fix --type=duration --file=data/tracks.json
