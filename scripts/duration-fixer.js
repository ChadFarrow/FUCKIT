...
/**
 * Universal duration fixing tool
 * 
 * Consolidated from: fix-durations.js, fix-all-durations.js, comprehensive-duration-fix.js, fix-durations-from-rss.js, fix-resolved-track-durations.js
 * Generated by: cleanup-and-consolidate-scripts.js
 * Created: 2025-08-09T23:22:12.868Z
 */
...
class UnifiedTool {
  ...
  showHelp() {
    console.log(`
🛠️  Universal duration fixing tool

Usage: node scripts/duration-fixer.js [command] [options]
...
Examples:
  node scripts/duration-fixer.js analyze --file=data/tracks.json
  node scripts/duration-fixer.js resolve --feed-guid=abc123 --item-guid=def456
  node scripts/duration-fixer.js fix --type=duration --file=data/tracks.json
