...
// TEMPORARILY FORCING ORIGINAL URLS UNTIL CDN IS FIXED
const isProduction = false; // Temporarily disabled until CDN Pull Zone is configured
...
const feedUrlMappings = [
  ...
  ['https://wavlake.com/feed/music/95ea253a-4058-402c-8503-204f6d3f1494', 'https://re-podtards-cdn.b-cdn.net/feeds/wavlake-95ea253a-4058-402c-8503-204f6d3f1494.xml'],
