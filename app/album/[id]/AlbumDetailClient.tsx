      ...
      const loadAlbum = async () => {
        try {
          ...
          const titleToFeedMap: { [key: string]: string } = {
            ...
            'featured-track-1902-2333': 'https://www.doerfelverse.com/feeds/playlist-track-2.xml',
            ...
            'featured-track-5544-5930': 'https://www.doerfelverse.com/feeds/playlist-track-3.xml',
