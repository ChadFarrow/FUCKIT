      ...
      <div className="container mx-auto px-6 py-8 pb-40">
        ...
        <div className="flex flex-col gap-6 mb-8">
          ...
          <div className="text-center space-y-4">
            <h1 className="text-3xl md:text-4xl font-bold leading-tight">Lightning Thrashes</h1>
            <p className="text-xl text-gray-300">Complete Collection</p>
            <p className="text-lg text-gray-300 italic">Episodes 1-60</p>
