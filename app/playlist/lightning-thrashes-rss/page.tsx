        ...
        <header className="border-b backdrop-blur-sm bg-black/30 pt-safe-plus pt-6" style={{borderColor: 'rgba(255, 255, 255, 0.1)'}}>
          <div className="container mx-auto px-6 py-2">
            <div className="text-center">
              <h1 className="text-3xl font-bold mb-1">Lightning Thrashes</h1>
              <p className="text-sm text-gray-400 mb-2">Music Playlist - Episodes 1-60</p>
              <div className="text-xs bg-orange-500/20 text-orange-300 px-3 py-1 rounded-full border border-orange-500/30 inline-block">
                RSS Feed Available
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-3 sm:px-6 py-6 sm:py-8 pb-28">
          ...
          <div className="mb-6">
            <nav className="flex items-center space-x-2 text-sm text-gray-400">
              ...
              <span>/</span>
              <span className="text-white">Lightning Thrashes</span>
            </nav>
          </div>
            ...
            <div className="flex items-start gap-4">
              <div className="w-16 h-16 bg-orange-500/20 rounded-lg flex items-center justify-center">
                <svg className="w-8 h-8 text-orange-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 18V5l12-2v13M9 19c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zm12-3c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zm12-3c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zM9 10l12-3" />
                </svg>
              </div>
              <div className="flex-1">
                <h2 className="text-xl font-bold text-white mb-2">Lightning Thrashes Playlist</h2>
                <p className="text-gray-300 mb-3">
                  A collection of music tracks from Lightning Thrashes episodes 1 through 60. 
